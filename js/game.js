...
let idleSpritesheet = { src: "img/player_idle.png", frameCount: 1, frameDuration: 10 };
let thrustSpritesheet = { src: "img/player_thrust.png", frameCount: 5, frameDuration: 50 };
...
function spawnPlanet(){
    ...
    let planet = new Planet(randomPlanet.image, 128, 128, canvas.width, getRandomHeight(), randomPlanet.frameCount, randomPlanet.frameDuration, scale);
...
function spawnGarbage(){
    ...
    // Create a new garbage object (Image, width, height, x, y, scale)
    let garbageObject = new Garbage(randomGarbageImage, 16, 16, canvas.width, getRandomHeight(), 3);
...
// Generate player
player = new Player(idleSpritesheet.image, thrustSpritesheet.image, 80, 108, 1, 50, 5, 50);
